...
!function (a) {
        ...
        b.on(this.mousedown, "button[data-cmd], li[data-cmd], span[data-cmd], a[data-cmd]", function (b) {
            ...
            if ("touchmove" != b.type) {
                ...
                if (c.options.inlineMode === !1 && 0 === a(d).parents(".froala-popup").length && (c.hide(), c.closeImageMode(), c.imageMode = !1), f) a(d).parents(".fr-dropdown").find(".fr-trigger.active").removeClass("active"), c[f](); else {
                    var g = a(d).attr("data-namespace"), h = a(d).attr("data-cmd"), i = a(d).attr("data-val"),
    ...
    a.Editable.prototype.initUndoRedo = function () {
        ...
        try {
            var c = this.getNodeByLocation(a.scLoc), d = a.scOffset, e = this.getNodeByLocation(a.ecLoc),
                f = a.ecOffset, g = this.document.createRange();
    ...
    a.Editable.prototype.getBoundingRect = function () {
        ...
        if (a(this.$editor.find('button.fr-bttn[data-cmd="' + b + '"]')).length) {
            var c = this.$editor.find('button.fr-bttn[data-cmd="' + b + '"]'), d = c.width(), e = c.height(),
    ...
    a.Editable.prototype.refreshImageAlign = function (a) {
        ...
        imageUploadToS3: !1,
        imageUploadURL: "http://"+window.location.hostname+"/upload",
        ...
        var e = this.$element.find("span.f-img-editor"), f = e.find("img"),
        ...
        var f = '<img class="' + e + ' fr-just-inserted" alt="' + this.options.defaultImageTitle + '" src="' + b + '"' + d + ">",
            g = this.getSelectionElements()[0], h = this.getRange(),
        ...
        if (void 0 !== b && b.length > 0) {
            ...
            if (c) {
                ...
                e.onload = a.proxy(function () {
                    ...
                    try {
                        let res = JSON.parse(e.responseText);  //custom code for upload
                        res.link = e.responseURL + 's/' + res.name; //custom code for upload
                        ...
                        else if (e.status >= 200 && e.status < 300) this.parseImageResponse(JSON.stringify(res)); //custom code for upload
                        else try {
